// Deno sample: Form cards (contact, survey, registration)
// 
// To run: deno run form_card_sample.ts
...
if (import.meta.main) {
  console.log('=== Form Card Samples ===\n');
  console.log('Contact Form:', JSON.stringify(createContactForm(), null, 2));
  console.log('\nSurvey Form:', JSON.stringify(createSurveyForm(), null, 2));
  console.log('\nRegistration Form:', JSON.stringify(createRegistrationForm(), null, 2));
}
