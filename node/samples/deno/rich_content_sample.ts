// Deno sample: Rich content cards (RichTextBlock, ImageSet, Table, Media)
// 
// To run: deno run rich_content_sample.ts
...
if (import.meta.main) {
  console.log('=== Rich Content Samples ===\n');
  console.log('Rich Text Card:', JSON.stringify(createRichTextCard(), null, 2));
  console.log('\nImage Set Card:', JSON.stringify(createImageSetCard(), null, 2));
  console.log('\nTable Card:', JSON.stringify(createTableCard(), null, 2));
  console.log('\nMedia Card:', JSON.stringify(createMediaCard(), null, 2));
  console.log('\nComprehensive Card:', JSON.stringify(createComprehensiveCard(), null, 2));
}
