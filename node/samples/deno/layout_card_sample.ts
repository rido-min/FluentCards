// Deno sample: Layout cards (columns, containers, facts)
// 
// To run: deno run layout_card_sample.ts
...
if (import.meta.main) {
  console.log('=== Layout Card Samples ===\n');
  console.log('Two Column Card:', JSON.stringify(createTwoColumnCard(), null, 2));
  console.log('\nStyled Container Card:', JSON.stringify(createStyledContainerCard(), null, 2));
  console.log('\nFact Set Card:', JSON.stringify(createFactSetCard(), null, 2));
  console.log('\nNested Container Card:', JSON.stringify(createNestedContainerCard(), null, 2));
}
